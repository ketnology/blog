                        ...
                        <div class="col-md-8">
                            <div class="main-container fl-wrap fix-container-init">
                                ...
                                <div class="single-post-header fl-wrap">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="author-link"><a href="author-single.html"><img src="images/avatar/2.jpg"
                                ...
                                <div class="single-post-content spc_column fl-wrap">
                                    ...
                                    <div class="fs-wrap smpar fl-wrap">
                                        <div class="fontSize"><span class="fs_title">Font size: </span><input
                                                type="text" class="rage-slider" data-step="1" data-min="12"
                                                data-max="15" value="12"></div>
                                        <div class="show-more-snopt smact"><i class="fal fa-ellipsis-v"></i></div>
                                        <div class="show-more-snopt-tooltip">
                                            <a href="#comments" class="custom-scroll-link"> <i
                                                    class="fas fa-comment-alt"></i> Write a Comment</a>
                                    ...
                                    <div class="single-post-content_text" id="font_chage">
                                        ...
                                        <div class="single-post-content_text_media fl-wrap">
                                            <div class="row">
                                                <div class="col-md-6"><img src="images/all/21.jpg" alt=""
                                                        class="respimg"></div>
                                                <div class="col-md-6">
                                                    <p> Cras lacinia magna vel molestie faucibus. Donec auctor et
                                                        ...
                                                        sit amet, consectetur adipiscing elit. Cras lacinia magna
                                                        vel molestie faucibus.Cras lacinia magna vel molestie
                                                        faucibus. </p>
                                                    <p> Cras lacinia magna vel molestie faucibus. Donec auctor et
                                                        urnaLorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                        Cras lacinia magna vel molestie faucibus.Cras lacinia magna
                                        ...
                                        <p> Cras lacinia magna vel molestie faucibus. Donec auctor et urnaLorem
                                            ipsum dolor sit amet, consectetur adipiscing elit. Cras lacinia magna
                                            vel molestie faucibus.Cras lacinia magna vel molestie faucibus. Donec
                                            auctor et urnaLorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Cras lacinia magna vel molestie faucibus.Cras lacinia magna vel molestie
                                            faucibus. </p>
                                        <h4 class="mb_head">Middle Post Heading</h4>
                                        <div class="single-post-content_text_media fl-wrap">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="has-drop-cap"> Cras lacinia magna vel molestie
                                                        faucibus. Donec auctor et urnaLorem ipsum dolor sit amet,
                                                        consectetur adipiscing elit. Cras lacinia magna vel molestie
                                                        faucibus.Cras lacinia magna vel molestie faucibus. Donec
                                                        auctor et urnaLorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit. Cras lacinia magna vel molestie
                                                        faucibus.Cras lacinia magna vel molestie faucibus.
                                                        faucibus.Cras lacinia magna vel molestie faucibus. </p>
                                                </div>
                                                <div class="col-md-6"><img src="images/all/18.jpg" alt=""
                                                        class="respimg"></div>
                                            </div>
                                        </div>
                                        <p> Cras lacinia magna vel molestie faucibus. Donec auctor et urnaLorem
                                        ...
                                        <blockquote>
                                            <p> Cras lacinia magna vel molestie faucibus. Donec auctor et urnaLorem
                                                ...
                                                magna vel molestie faucibus.Cras lacinia magna vel molestie
                                                faucibus. Donec auctor et urnaLorem ipsum dolor sit amet,
                                                consectetur adipiscing elit. Cras lacinia magna vel molestie
                                                faucibus.Cras lacinia magna vel molestie faucibus. </p>
                                        </blockquote>
                                        <p>Lorem ipsum dosectetur adipisicing elit, sed do.Lorem ipsum dolor sit
                                            ...
                                            ipsum dosectetur adipisicing elit at leo dignissim congue. Mauris
                                            elementum accumsan leo vel tempor</p>
                                        <p> Aliquam et elit eu nunc rhoncus viverra quis at felis. Sed do.Lorem
                                            ipsum dolor sit amet, consectetur Nulla fringilla purus Lorem ipsum
                                            dosectetur adipisicing elit at leo dignissim congue. Mauris elementum
                                            accumsan leo vel tempor.</p>
                                    </div>
                                    ...
                                    <div class="single-post-nav fl-wrap">
                                        <a href="post-single.html" class="single-post-nav_prev spn_box">
                                            ...
                                            <div class="spn-box-content">
                                                <span class="spn-box-content_subtitle"><i
                                                        class="fas fa-caret-left"></i> Prev Post</span>
                                                <span class="spn-box-content_title">New VR Glasses and Headset
                                                    System Release</span>
                                            </div>
                                        </a>
                                        <a href="post-single.html" class="single-post-nav_next spn_box">
                                            ...
                                            <div class="spn-box-content">
                                                <span class="spn-box-content_subtitle">Next Post <i
                                                        class="fas fa-caret-right"></i></span>
                                                <span class="spn-box-content_title">$310m to help businesses in
                                                    latest Lockdow</span>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="post-author fl-wrap">
                                    ...
                                    <div class="author-content fl-wrap">
                                        ...
                                        <p>At one extremity the rope was unstranded, and the separate spread yarns
                                            ...
                                            then driven hard up into the socket..</p>
                                    </div>
                                    <div class="profile-card-footer fl-wrap">
                                        <a href="author-single.html" class="post-author_link">View Profile <i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-content">
                                                        <h3><a href="post-single.html">Warriors face season defining
                                                                clash</a></h3>
                                ...
                                <div id="comments" class="single-post-comm fl-wrap">
                                    ...
                                    <ul class="commentlist clearafix">
                                        <li class="comment">
                                            <div class="comment-author">
                                                <img alt="" src="images/avatar/2.jpg" width="50"
                                                    height="50">
                                            </div>
                                            <div class="comment-body smpar">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                                    ...
                                                    eget blandit nunc tortor eu nibh. Nullam mollis. Ut justo.</p>
                                                <a class="comment-reply-link" href="#"><i
                                                        class="fas fa-reply"></i>
                                                    Reply</a>
                                                <div class="comment-meta"><i class="far fa-clock"></i> January 02,
                                                    2020</div>
                                        ...
                                        <li class="comment comment_reply">
                                            <div class="comment-author">
                                                <img alt="" src="images/avatar/4.jpg" width="50"
                                                    height="50">
                                            </div>
                                            <div class="comment-body smpar">
                                    ...
                                    <div id="addcom" class="clearafix">
                                        <div class="pr-subtitle"> Leave A Comment <i class="fas fa-caret-down"></i>
                                        </div>
                                        <div class="comment-reply-form fl-wrap">
                                            <form id="add-comment" class="add-comment custom-form">
                                                ...
                                                <button class="btn float-btn color-btn"> Submit Comment <i
                                    ...
                                    <div class="box-widget-content">
                                        <div class="banner-widget fl-wrap">
                                            ...
                                            <div class="banner-widget_content">
                                                ...
                                                <a href="#" class="btn float-btn color-bg small-btn">Our
                                                    shop</a>
                                            </div>
                                        </div>
                                    </div>
