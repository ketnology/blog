    ...
    <div class="panel-body">
            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
                <div class="form-group row m-b-15">
                    {{-- <label class="col-md-4 col-sm-4 col-form-label" for="message">comments:</label> --}}
                    <div class="col-md-8 col-sm-8">
                        <textarea class="form-control" id="message" name="message" rows="15" placeholder="Comment"></textarea>
                    </div>
                </div>
        ...
        <li>
            ...
            <div class="timeline-body">
                ...
                <div class="timeline-content">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc faucibus turpis quis
                        tincidunt luctus.
            ...
            <div class="timeline-body">
                ...
                <div class="timeline-content">
                    <p class="lead">
                        ...
                        Quisque sed varius nisl. Nulla facilisi. Phasellus consequat sapien sit amet nibh
                        molestie placerat. Donec nulla quam, ullamcorper ut velit vitae, lobortis condimentum
                        magna. Suspendisse mollis in sem vel mollis.
            ...
            <div class="timeline-body">
                ...
                <div class="timeline-content">
                    ...
                    <p>In hac habitasse platea dictumst. Pellentesque bibendum id sem nec faucibus. Maecenas
                        molestie, augue vel accumsan rutrum, massa mi rutrum odio, id luctus mauris nibh ut leo.
                    </p>
                    <p class="m-t-20">
